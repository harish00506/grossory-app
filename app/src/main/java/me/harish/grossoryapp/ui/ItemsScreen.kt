...
fun  ItemsScreen(
    ...
    LazyVerticalGrid(
        ...
        item(
            ...
            Column {
                Image(painter = painterResource(id = R.drawable.banana_fruit), contentDescription = "offer")
                Card(
        ...
        Card(
            ...
            Box {
                AsyncImage(
                    ...
                    contentDescription = "Item name $stringResourceId",
                    modifier = Modifier
                        .fillMaxWidth()
                        .height(110.dp)
                )
...
fun ErrorScreen(flashViewModel: FlashViewModel){
    Column (
        ...
        Text(
            text = "Oops! Internet unavailable.Please Check your internet connection.",
            modifier = Modifier.fillMaxWidth()
                .padding(20.dp),
            textAlign = TextAlign.Center
        )
